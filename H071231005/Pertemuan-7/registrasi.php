...
<body class="h-screen bg-cover"  style="background-image: url('image/background.jpg')">
    <div class="container mx-auto mt-5 max-w-md">
        ...
        <?php } ?>
    <div class="mt-10">
    <form method="POST" action="" class="bg-slate-800/50 shadow-md  px-8 pt-6 pb-8">
        <h2 class="text-xl text-white font-bold mb-4 text-center">Register Mahasiswa</h2>
            <div class="mb-4">
                <label class="block text-white text-sm font-bold mb-2" for="nim">
                    NIM:
                </label>
            ...
            <div class="mb-6">
                <label class="block text-white text-sm font-bold mb-2" for="prodi">
                    Program Studi:
                </label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" 
            ...
            <div class="flex items-center justify-between">
                ...
                <a class="inline-block align-baseline font-bold text-sm text-white" href="login.php">
