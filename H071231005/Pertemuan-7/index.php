...
<body>
    ...
    <div class="fixed top-0 w-full">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-4xl font-semibold whitespace-nowrap text-white" style="font-family: 'harry';">Hogwarts</span>
            </a>
    ...
    <div class="p-6 mx-auto mb-6 mt-6">
        <div>
        <?php if ($role == 'admin') { ?>
        <form method="POST" action="" class="bg-white/20 p-4 rounded shadow-md mb-4 ">
                <?php if ($edit_mode) { ?>
            ...
            <form class="flex items-center max-w-sm mx-auto" method="GET" action="">   
                ...
                <div class="relative w-full">
                    <input type="text" 
                        id="simple-search" 
                        name="search" 
                        class="bg-gray-50/20 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" 
        ...
        <div class="bg-white/20 rounded shadow-md overflow-x-auto">
            <table class="w-full">
