...
function countEvenNumbers(start, end) {
    ...
    return hasil + " (" + angka.join(", ") + ")";
}


let start = Number(prompt("Masukkan angka awal:"));
let end = Number(prompt("Masukkan angka akhir:"));
...
if (typeof start !== "number" || typeof end !== "number") {
    document.write("<p>Input harus berupa angka</p>");
} else {
    document.write("<h2>Nomor 1</h2>");
    document.write("<p>" + countEvenNumbers(start, end) + "</p>");
    alert(result);  
    console.log(result);  
 }
